...
function PastWinners() {
  ...
  useEffect(() => { void Promise.all([loadGiveaways(), loadWinners()]).then(([giveawayRows, winnerRows]) => { setGiveaways(giveawayRows); setWinners(winnerRows); }); }, [loadGiveaways, loadWinners]);
